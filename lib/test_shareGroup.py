...
def shareeOne(step):
    ...
    step(5,'Sharee One syncs and validate files does not exist')
    ...
    error_check(not os.path.exists(sharedFile), "File %s should exist" %sharedFile)
...
def shareeTwo(step):
    ...
    step(5,'Sharee Two syncs and validate files does not exist')
    ...
    step (8, 'Sharee Two shares file with user 2')
