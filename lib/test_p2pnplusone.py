...
__doc__ = """ Add nfiles to a directory and check consistency. P2P version of nplusone
"""
...
def worker1(step):
    ...
    """ Option for seafile - if multi is specified, all sync clients will be running before the start of worker1 client, 
    giving a posibility of P2P sync for seafile"""
    run_ocsync(d,option="multi")
