...
def is_dropbox_running():
    global DROPBOX_VAR
    pidfile = os.path.expanduser(DROPBOX_VAR+"/dropbox.pid")
...
class DropboxCommand(object):
    ...
    def __init__(self, timeout=5):
        ...
        try:
            self.s.connect(os.path.expanduser(DROPBOX_VAR+"/command_socket"))
...
def requires_dropbox_running(meth):
    def newmeth(*n, **kw):
        if is_dropbox_running():
            ...
            console_print(u"Dropbox isn't running! REQUIRESDR")
    newmeth.func_name = meth.func_name
    newmeth.__doc__ = meth.__doc__
    return newmeth

def start_dropbox():
    db_path = os.path.expanduser(str(DROPBOXD_PATH)).encode(sys.getfilesystemencoding())
...
"""
    ...
    try:
        ...
        console_print(u"Dropbox isn't running! FILESTATUS")
...
"""
    ...
    try:
        ...
        console_print(u"Dropbox isn't running - DROPBOXCOMMAND!")
...
"""
    ...
    try:
        ...
        console_print(u"Dropbox isn't running! STATUS")
...
"""
    try:
        ...
        console_print(u"Dropbox isn't running! STOP")
...
def grab_link_url_if_necessary():
    try:
        ...
        console_print(u"Dropbox isn't running! GRABURL")
...
"""
    if len(args) == 0:
        try:
            ...
            console_print(u"Dropbox isn't running! EXCLUDE")
...
"""
    ...
    print "first check if dropbox is already running"
    if is_dropbox_running():
...
if __name__ == "__main__":
    ...
    for i in range(0, len(sys.argv)):
        if(i==1 and sys.argv[i]=="--set"):
            DROPBOX_VAR = sys.argv[i+1]
        else:
